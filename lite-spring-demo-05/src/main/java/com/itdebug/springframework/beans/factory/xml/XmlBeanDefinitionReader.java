...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
    ...
    @Override public void loadBeanDefinitions(Resource resource) throws SpringBeansException {
    ...
    @Override public void loadBeanDefinitions(Resource... resources) throws SpringBeansException {
        for (Resource resource : resources) {
            loadBeanDefinitions(resource);
        }
    }

    @Override public void loadBeanDefinitions(String location) throws SpringBeansException {
